...
/**
 * Những thứ cần khi xem một loại nguyên liệu 
...
class Ingredients
{
    ...
    {
        try {
            $sqlStatement = "select id, name, category, measurementUnit, specialRequirement, nutritionComponents from ingredients where id=:id";
